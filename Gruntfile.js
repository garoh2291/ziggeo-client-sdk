module.exports = function (grunt) {
  ...
  gruntHelper.config = {
    ...
    scoped: {
      js_scoped: {
        ...
        src: [
          ...
          {
            src: require.resolve(
              "betajs-browser/dist/betajs-browser-noscoped.js"
            ),
            bindings: {
              base: "root:BetaJS",
          ...
          {
            src: require.resolve(
              "betajs-dynamics/dist/betajs-dynamics-noscoped.js"
            ),
            bindings: {
              base: "root:BetaJS",
              browser: "root:BetaJS.Browser",
          ...
          {
            src: require.resolve(
              "betajs-media-components/dist/betajs-media-components-noscoped.js"
            ),
            bindings: {
              base: "root:BetaJS",
              browser: "root:BetaJS.Browser",
          ...
          CustomCompileOptions.themes.modern
            ? {
                src: require.resolve(
                  "betajs-media-components/dist/themes/modern/script.js"
                ),
                bindings: {
                  browser: "root:BetaJS.Browser",
                  dynamics: "root:BetaJS.Dynamics",
            ...
            : null,
          CustomCompileOptions.themes.cube
            ? {
                src: require.resolve(
                  "betajs-media-components/dist/themes/cube/script.js"
                ),
                bindings: {
                  browser: "root:BetaJS.Browser",
                  dynamics: "root:BetaJS.Dynamics",
            ...
            : null,
          CustomCompileOptions.themes.space
            ? {
                src: require.resolve(
                  "betajs-media-components/dist/themes/space/script.js"
                ),
                bindings: {
                  browser: "root:BetaJS.Browser",
                  dynamics: "root:BetaJS.Dynamics",
            ...
            : null,
          CustomCompileOptions.themes.minimalist
            ? {
                src: require.resolve(
                  "betajs-media-components/dist/themes/minimalist/script.js"
                ),
                bindings: {
                  browser: "root:BetaJS.Browser",
                  dynamics: "root:BetaJS.Dynamics",
            ...
            : null,
          CustomCompileOptions.themes.theatre
            ? {
                src: require.resolve(
                  "betajs-media-components/dist/themes/theatre/script.js"
                ),
                bindings: {
                  browser: "root:BetaJS.Browser",
                  dynamics: "root:BetaJS.Dynamics",
            ...
            : null,
          CustomCompileOptions.themes.elevate
            ? {
                src: require.resolve(
                  "betajs-media-components/dist/themes/elevate/script.js"
                ),
                bindings: {
                  browser: "root:BetaJS.Browser",
                  dynamics: "root:BetaJS.Dynamics",
    ...
    uglify: {
      ...
      build: {
        src: "dist/ziggeo-client-sdk.js",
        dest: "dist/ziggeo-client-sdk.min.js",
      },
    },
  };
  ...
  gruntHelper
    .concatTask(
      ...
      [
        require.resolve(
          "betajs-media-components/demos/playerjs/player-0.1.0.js"
        ),
        require.resolve(
          "betajs-media-components/demos/playerjs/betajs-adapter.js"
        ),
      ],
      "temp/playerjs.js",
      {
    ...
    .uglifyTask(
      "playerjs-uglify",
      "temp/playerjs.js",
      "build/playerjs-adapter.js"
    )
    .simplecopyTask("copy-assets", {
      "build/ziggeo-ie8.eot": require.resolve(
        "betajs-media-components/dist/bjsmc-ie8.eot"
      ),
    ...
    .concatTask(
      ...
      [
        require.resolve(
          "betajs-media-components/dist/betajs-media-components.css"
        ),
        CustomCompileOptions.themes.modern
          ? require.resolve(
              "betajs-media-components/dist/themes/modern/style.css"
            )
          : null,
        CustomCompileOptions.themes.cube
          ? require.resolve(
              "betajs-media-components/dist/themes/cube/style.css"
            )
          : null,
        CustomCompileOptions.themes.elevate
          ? require.resolve(
              "betajs-media-components/dist/themes/elevate/style.css"
            )
          : null,
        CustomCompileOptions.themes.minimalist
          ? require.resolve(
              "betajs-media-components/dist/themes/minimalist/style.css"
            )
          : null,
        CustomCompileOptions.themes.theatre
          ? require.resolve(
              "betajs-media-components/dist/themes/theatre/style.css"
            )
          : null,
        CustomCompileOptions.themes.space
          ? require.resolve(
              "betajs-media-components/dist/themes/space/style.css"
            )
          : null,
        "./src/css/*.css",
      ].filter(notNull),
    ...
    .replacerTask("css-replace", "temp/ziggeo-raw.css", "temp/ziggeo.css", {
      "ziggeo-ie8.eot": "bjsmc-ie8.eot",
    })
    .cssminTask("css-min", "temp/ziggeo.css", "build/ziggeo.css")
    .csslinterTask("css-lint", ["temp/ziggeo.css"])
    .yamltojsTask(
      "js-locales",
      CustomCompileOptions.locales === true
        ? ["src/locales/*.yml"]
        : CustomCompileOptions.locales.map(function (l) {
    ...
    .qunitTask(
      "jsdomqunit",
      "tests/qunit/credentials.js",
      grunt.file.expand(["./tests/qunit/qunit.js", "./tests/qunit/tests/*.js"]),
      [],
      { timeout: 1000 * 60 * 60 }
    )
  ...
  grunt.registerTask("package-locales", ["shell:package-locales"]);

  grunt.registerTask("playerjs", ["playerjs-concat", "playerjs-uglify"]);
  ...
  grunt.registerTask("locale-update-translations", function () {
    ...
    languages.forEach(function (targetLang) {
      ...
      var target = grunt.file.exists(targetFile)
        ? loadLocale(targetFile)
        : { language: targetLang, dict: {} };
      ...
      if (keys.length > 0) {
        var translate = translate(
          JSON.parse(grunt.file.read("./google-translate-creds.json"))
        );
        translate.translate(
          values,
